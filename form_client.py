...
from storage_sqlite import Storage, PATH, History_Message, History, Contacts
...
class Ui_MainWindow(object):
    ...
    def client_click(self):
        ...
        if a != "" and b.isdigit():
            ...
            self.con = Client(a, int(b), res_queue=self.res_queue)
            server_proc = Thread(target=self.con.client_original)
